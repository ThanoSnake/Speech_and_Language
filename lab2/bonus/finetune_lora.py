...
BATCH_SIZE = 32
LEARNING_RATE = 2e-4  # LoRA benefits from a higher LR than full fine-tuning
MAX_LENGTH = 128
WARMUP_RATIO = 0.1
...
# LoRA config
# ============================================================
# rank 8 for most layers; rank 16 for the classifier head since
# it needs more capacity to adapt the final decision boundary.
#
# target_modules covers:
#   - attention: query, key, value projections + output dense
#   - FFN: intermediate.dense + output.dense
#   - classifier: the 2-class head
#
# modules_to_save ensures the classifier head is fully trainable
# (not just low-rank), since it's small and task-critical.
